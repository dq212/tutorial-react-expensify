...
import {startAddExpense, addExpense, editExpense, removeExpense, setExpenses, startSetExpenes} from '../../actions/expenses';
...
beforeEach((done)=>{
    const expensesData = {};
    expeneses.forEach(({id, description, note, amount, createdAt})=>{
